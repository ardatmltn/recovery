      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          <div className="md:col-span-7 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-2xl p-8 transition-all duration-300 group">
            <div className="w-10 h-10 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-blue-500/15 transition-colors">
      ...
      <section className="py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="relative bg-zinc-900 border border-zinc-800 rounded-3xl p-12 md:p-20 overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-blue-500/[0.05] blur-[100px] pointer-events-none" />
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/register" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-500 hover:bg-blue-400 text-black font-semibold rounded-full text-sm transition-all shadow-[0_0_32px_rgba(59,130,246,0.2)] hover:shadow-[0_0_48px_rgba(59,130,246,0.38)] hover:-translate-y-0.5">
                  {tx.cta.btn1}
                </Link>
