...
import { Zap, TrendingUp, Mail, RefreshCw, BarChart3, Shield, Check } from 'lucide-react'
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { icon: Shield, title: 'Secure & Compliant', desc: 'Bank-level security with end-to-end encryption. SOC2 compliant. Your data never leaves your control.' },
