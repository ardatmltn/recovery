        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-sm font-semibold text-white">{recoveredCount ?? 0} {t.payments}</span>
                </div>
                <div className="w-full bg-zinc-800 rounded-full h-2">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6">
            ...
            <div className="space-y-3">
              {[
                { label: t.activeFailuresLabel, value: activeFailures ?? 0, color: 'text-red-400' },
                { label: t.recoveredLabel, value: recoveredCount ?? 0, color: 'text-green-400' },
                { label: t.totalEvents, value: (activeFailures ?? 0) + (recoveredCount ?? 0), color: 'text-blue-400' },
                { label: t.analyticsDays, value: analytics?.length ?? 0, color: 'text-purple-400' },
