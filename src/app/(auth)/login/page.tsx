    ...
    <div className="min-h-screen bg-[#09090B] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
          <h1 className="font-display font-bold text-white text-2xl mb-1">Sign in</h1>
          <p className="text-zinc-500 text-sm mb-6">Welcome back</p>

          <button
            type="button"
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-zinc-700 hover:border-zinc-600 bg-zinc-800/50 hover:bg-zinc-800 text-zinc-300 hover:text-white text-sm font-medium transition-colors mb-5"
          >
