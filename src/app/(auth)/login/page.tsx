    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 16px' }}>
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ background: '#131313', border: '1px solid #242424', borderRadius: 20, padding: 32 }}>
          <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: '#fff', fontSize: 22, marginBottom: 4 }}>Sign in</h1>
          <p style={{ color: '#6b6b6b', fontSize: 13, marginBottom: 24 }}>Welcome back</p>
          ...
          <button
            ...
            style={{
              ...
              padding: '10px 16px', borderRadius: 12, border: '1px solid #2a2a2a',
              background: '#1a1a1a', color: '#adaaaa', fontSize: 13, fontWeight: 500,
              cursor: 'pointer', transition: 'border-color 0.15s, color 0.15s', marginBottom: 20,
            }}
            onMouseEnter={(e) => { (e.currentTarget).style.borderColor = '#3a3a3a'; (e.currentTarget).style.color = '#fff' }}
            onMouseLeave={(e) => { (e.currentTarget).style.borderColor = '#2a2a2a'; (e.currentTarget).style.color = '#adaaaa' }}
          >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
            ...
            <span style={{ color: '#4a4a4a', fontSize: 11 }}>or</span>
            <div style={{ flex: 1, height: 1, background: '#242424' }} />
          </div>
        ...
        <p style={{ color: '#4a4a4a', fontSize: 13, textAlign: 'center', marginTop: 20 }}>
          ...
          <Link href="/register" style={{ color: '#8a8a8a', textDecoration: 'none' }}
